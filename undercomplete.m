function [y_re] = undercomplete(y, B, block_size, hop_size, window, weight_pole)

% function [y_re] = undercomplete(y, B, block_size, hop_size, window, weight_pole)
% 
% Model an input signal y using only a set of basis vectors defined by B, 
% L2+L1 optimization is used to determine the optimal weighting for the given basis.
%
% "Standard" variant
% 
% === REQUIRED ARGUMENTS ===
...
% === OPTIONAL ARGUMENTS ===
% block_size
%	length of block to operate on; should typically equal the column length of B.
%	(default: 1024)
%
% hop_size
